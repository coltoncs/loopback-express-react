...
describe('NoteApplication', () => {
    ...
    before('setupApplication', async () => {
        ({ server, client, lbApp } = await (0, test_helper_1.setupExpressApplication)());
